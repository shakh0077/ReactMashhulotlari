  ...
  return (
    <div>
        <div id='products' className=' w-full  px-5  mx-auto lg:max-w-[1440px] '>
            <div className= '  grid grid-cols-1 mx-auto  md:grid-cols-3 lg:grid-cols-4 lg:gap-24'>
            ...
            <div className='px-10 pb-8 text-start lg:text-center'>
                <button className='py-3 px-16 border-2 whitespace-nowrap border-[#E89F71] text-[#E89F71]'><a href="#rooms">Show More</a></button>
            </div>
