...
const Tips = () => {
  ...
  return (
    <div className={`${
      ...
      <div
        id='tips'
        className='max-w-[1440px] mx-auto py-10 px-5'
      >
        ...
        <div className='relative'>
            ...
            {slides.map((slide) => (
              <SwiperSlide key={slide.id}>
                ...
                >
                  ...
                  hover:scale-105 hover:shadow-xl w-full h-[250px] object-cover'
                  />
          ...
          <button
            data-aos='fade-right'
            className='prev-button absolute -left-5 top-1/2 transform -translate-y-1/2 text-[#E89F71] bg-white p-3 rounded-full shadow-md border z-10'
          >
            <FaArrowLeft />
          </button>
          <button
            data-aos='fade-left'
            className='next-button absolute -right-5 top-1/2 transform -translate-y-1/2 text-[#E89F71] bg-white p-3 rounded-full shadow-md border z-10'
          >
            <FaArrowRight />
          </button>
        </div>
